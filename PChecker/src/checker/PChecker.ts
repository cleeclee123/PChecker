...
export class PChecker {
  ...
  constructor(
    ...
    this.optionspj_ = {
      ...
      method: "GET",
      path: PChecker.kProxyJudgeURL,
      headers: {
        "User-Agent":
          PChecker.kUserAgents[
            Math.floor(Math.random() * PChecker.kUserAgents.length)
          ],
      },
    };
    ...
    this.optionstd_ = {
      ...
      port: Number(this.port_),
      method: "GET",
      path: PChecker.kTestDomain, // @TODO: CHANGE BACK TO kTestDomain
      headers: {
        "User-Agent":
          PChecker.kUserAgents[
            Math.floor(Math.random() * PChecker.kUserAgents.length)
